...
import { getPastEvets } from "../../api/EventAction";
import { IEvent } from "../../interfaces/CardInterface";
...
const PastEvents: React.FC = () => {
  ...
  const [pastEvents, getPastEvents] = useState<IEvent[]>();

  useEffect(() => {
    getPastEvents()
        .then((response) => {
          getPastEvents(response.data);
        })
        .catch((error) => {
